...
# Title of the app
st.title("Random Forest Model Application")
...
def clf_predict(CustomerID, Age, TypeofContact, CityTier, DurationOfPitch, Occupation, Gender, NumberOfFollowups, ProductPitched, 
    ...
    # Create input data
    input_data = np.array([[CustomerID, Age, TypeofContact, CityTier, DurationOfPitch, 
...
if app_mode == "Regression: Car Selling Price Prediction":
    ...
    st.header("Predict Holiday Package Purchase using Random Forest")
